...
export class Share {
  ...
  setTwitterShareLinks(emojiList: string) {
    ...
    const shareHref = document.documentElement.lang === 'ja' ? (
      ...
      `https://twitter.com/intent/tweet?text=I%20found%20${encodedEmojiList}` +
      '%20in%20the%20real%20world.%20How%20many%20can%20you%20find%3F' +
      '%20Start%20your%20search%20at&hashtags=AIExperiments,tensorflowjs' +
      '&url=https%3A%2F%2Fg.co%2Femojiscavengerhunt');
    this.shareLinkAllItemsTwitter.href = shareHref;
    this.shareLinkXItemsTwitter.href = shareHref;
  }
}
